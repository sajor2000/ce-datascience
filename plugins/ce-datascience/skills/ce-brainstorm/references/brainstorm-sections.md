...
In `ce-datascience`, "requirements" includes research-question briefs, study
design handoffs, analysis briefs, and health-data workflow specifications.
Translate generic product terms accordingly: user behavior may be study flow,
clinical workflow, analyst workflow, data access, cohort definition, endpoint
definition, reporting checklist coverage, or reproducibility criteria. Do not
turn a biomedical research brainstorm into a generic product PRD.

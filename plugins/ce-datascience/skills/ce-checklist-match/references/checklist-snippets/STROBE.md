...
22-item checklist for cohort, case-control, and cross-sectional studies. Fill each row as the SAP and manuscript develop.

| # | Item | Section | Status | Note |
|---|------|---------|--------|------|
| 1a | Indicate study design in title or abstract | Title/Abstract | ☐ | |
| 1b | Provide a balanced summary of what was done and what was found | Abstract | ☐ | |
| 2 | Explain the scientific background and rationale | Introduction | ☐ | |
...
| 17 | Analyses for subgroups, interactions, sensitivity | Results | ☐ | |
| 18 | Summarize key results | Discussion | ☐ | |
| 19 | Discuss limitations | Discussion | ☐ | |
| 20 | Cautious overall interpretation | Discussion | ☐ | |
| 21 | Generalisability | Discussion | ☐ | |
| 22 | Source of funding and role of funders | Funding | ☐ | |

For RECORD extension (when data source is routinely-collected): add 7 RECORD items on data source description, code lists, data linkage, data cleaning, missingness, study population access.

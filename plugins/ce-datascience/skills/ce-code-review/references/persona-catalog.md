...
| `ce-calibration-reviewer` | prediction-model eval code that produces predicted probabilities -- calibration plot, intercept/slope, Brier, ICI, decision-curve analysis, and decision-aligned censoring-aware time-dependent AUC for survival models |

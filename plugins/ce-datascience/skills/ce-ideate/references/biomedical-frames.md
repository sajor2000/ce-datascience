...
1. **Pick one and load the `ce-research-question` skill on it** (recommended) — hardens the survivor into `analysis/research-question.yaml` with a tested PubMed query, full PICO, and reporting-checklist routing input.

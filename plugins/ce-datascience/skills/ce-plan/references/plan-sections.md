...
In `ce-datascience`, implementation plans may be software plans, statistical
analysis plans, or health-data workflow plans. Preserve biomedical research
constraints when applying this section contract: population/exposure/outcome
definitions, estimands, SAP versioning, bias/confounding assumptions, data
quality checks, reporting checklist obligations, and R/Python reproducibility
can be load-bearing decisions just like code architecture.

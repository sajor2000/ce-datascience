#!/usr/bin/env python3
"""
list-plugin-releases.py — Fetch ce-datascience plugin releases from GitHub.
...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch ce-datascience plugin releases from GitHub."
    )
    parser.add_argument(
        "--limit",
        type=int,

...
```bash
gh issue create \
  --repo sajor2000/ce-datascience \
  --title "[ce-datascience] Bug: [Brief description]" \
  --body "[Formatted bug report from Step 3]" \
  --label "bug,ce-datascience"
```
...
3. Let them know the repository maintainers will be notified
...
Issue: https://github.com/sajor2000/ce-datascience/issues/[NUMBER]
Title: [ce-datascience] Bug: [description]

Thank you for helping improve the ce-datascience plugin!
